...
(() => {
  ...
  let renderedModal = null, avatarPage = 0, forceModalTop = false, introReplay = false, conversation = 'group', conversationList = false, atlasTab = 'bird', sleepMinutes = 480, calendarMonth = 3, calendarDay = 1;
  ...
  function renderModal() {
    ...
    if (modal === 'chat') content=frame('聊天软件','群聊、好友与支线',chatApp(state,conversation,conversationList),true);
